<?php
   session_start();
     ...
     $count= connect()->prepare("SELECT count(id) AS cpt FROM livres");
     ...
     $reqlivre = connect()->prepare("SELECT * FROM livres ORDER BY id DESC LIMIT $debut,$nb_elements_page");
         ...
         <nav id="navbar" class="navbar">
           <ul>
             ...
             <li class="dropdown"><a href="category.html"><span>Categories</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
               <ul>
                 <li><a href="search-result.html">S'inscrire</a></li>
