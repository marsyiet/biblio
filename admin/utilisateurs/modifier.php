<?php
   ...
   // if($_SESSION["id"]){
    ...
    try{
      ...
      connect();    
      $requete1 = connect()->prepare("SELECT * FROM user WHERE id= ?");
   ...
   if (isset($_POST['modifier'])) 
    {
            ...
            $error = "";
                ...
                echo "error";
                    ...
                    $requete = connect()->prepare("UPDATE user SET  login = :login, password = :password WHERE id = :id1");
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <input type="hidden" value="<?php echo $reponse['id']; ?>" name="id" >
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputlogin1" placeholder="login" value="<?php echo $reponse['login']; ?>" name="login">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="exampleInputpassword1" placeholder="password" value="<?php echo $reponse['password']; ?>" name="password">
                </div>
                <div class="mb-4">
                </div>
                <div class="mt-3">
